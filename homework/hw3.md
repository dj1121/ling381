...
2. Pick a stance (agree or disagree) and make your stance clear. It's okay if it's not your real opinion since this is just practice.
3. Defend your stance with two-three pieces of evidence.
...
2. Describe the process using an introduction (why do it), body (how to do it), and conclusion (summary).
